...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate, UNUserNotificationCenterDelegate{
    ...
    func monitor() {
        ...
        if GlobalData.students.count > 20{
            ...
            for i in 0...GlobalData.students.count-1{
                let newRegion = CLBeaconRegion(proximityUUID: uuid!, major:UInt16(GlobalData.students[i].major!), minor: UInt16(GlobalData.students[i].minor!), identifier: String(GlobalData.students[i].id!))
                if i<19{
                    locationManager.startMonitoring(for: newRegion)
    ...
    func locationManager(_ manager: CLLocationManager, didDetermineState state: CLRegionState, for region: CLRegion) {
        ...
        case .inside:
            ...
            /*if let mRegion = region as? CLBeaconRegion{
             print(mRegion.major)
             print(mRegion.minor)
             }*/
